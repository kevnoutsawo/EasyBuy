<div id="believe-nav"> <!-- Nav -->
    <div class="container">
                                ...
                                <div>
                                    <form class="side-search">
                                        <div class="input-group">
                                            <input type="text" class="form-control search-wid" placeholder="Rechercher un produit" aria-describedby="basic-addon1">
        ...
        <div class="srch-form">
            <form class="side-search">
                <div class="input-group">
                    <input type="text" class="form-control search-wid" placeholder="Rechercher un produit" aria-describedby="basic-addon2">
  ...
  <!--
  If vertical categories are necessary, maybe use this
  <div id="cat-nav">
    <div class="container">
        <div class="wrap-cat">
        ...
        <div class="collapse navbar-collapse" id="cat-nav-mega">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown menu-large">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">HOMMES <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu megamenu" role="menu">
                        <li>
                            <div class="">
                                <div class="mega-sub">
                                    <div class="mega-sub-title">Vêtements</div>
                                    <ul>
                                        <li><a href="">T-Shirts</a></li>
                                        <li><a href="">Tenues de fête</a></li>
                                        <li><a href="">Jeans</a></li>
                                        <li><a href="">T-Shirts respo</a></li>
                                        <li><a href="">Shorts</a></li>
                                        <li><a href="">Tenues de Sport</a></li>
                                        <li><a href="">Pantalons</a></li>
                                        <li><a href="">Costumes et Blazers</a></li>
                                        <li><a href="">Tenues traditionnelles</a></li>
                                        <li><a href="">Tenues de nuit</a></li>
                                        <li><a href="">Accessoires</a></li>
                                    </ul>
                                </div>
                                <div class="mega-sub">
                                    <div class="mega-sub-title">Chaussures</div>
                                    <ul>
                                ...
                                <div class="mega-product">
                                    <div class="mega-sub-title">Populaires</div>
                                    <div class="row">
                                        <div class="col-md-6 prdct-grid">
                                                ...
                                                <div class="product-fade-wrap">
                                                    ...
                                                    <div class="product-fade-ct">
                                                        <div class="product-fade-control">
                                                            ...
                                                            <a href="" class="btn btn-to-cart"><span class="bag"></span><span>Ajouter au panier</span><div class="clearfix"></div></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="product-price">
                                                <span>15 000 FCFA</span> 8 500 FCFA
                                            </div>
                                        </div>
                                        <div class="col-md-6 prdct-grid">
                                            <div class="product-fade">
                ...
                <li><a href="blog.html">FEMMES </a></li>
                <li><a href="contact.html">ENFANTS</a></li>
                <li><a href="contact.html">LIVRES & MEDIA </a></li>
                <li><a href="contact.html">MAISON & CUISINE </a></li>
