  ...
  <div id="header"> <!-- header -->
    <div class="top"> <!-- top -->
      <div class="container">
        ...
        <div class="top-offers">
            <div class="alert alert-warning alert-dismissible fade in offers" role="alert">
                ...
                Livraison gratuites <a href="">pour toutes les commandes supérieures à </a> 50 000 FCFA!
            </div>
        </div>
      -->
      <div class="top-control">
        <ul>
          <li>
            <a type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal">Créer gratuitement mon compte </a>
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Créer mon compte</h4>
                  </div>
            ...
            <span>•</span>
            <li class="dropdown">
              <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal2">Connexion </button>
                        ...
                        <div class="text-center">
                          <form action="" method="post" role="form">
                            <div class="form-group">
                              ...
                              <input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Nom d'utilisateur" value="" autocomplete="off">
                            </div>
