        ...
        <?php include('navbar.php'); ?>
          ...
          <div id="main-slider"> <!-- Slider -->
              <div id="home-slider" class="owl-carousel owl-theme">
                  ...
                  <div class="item">
                      <img src="images/luxury-home.jpg" alt="slide-3" class="img-responsive">
                      <div class="slider-desc">
                          <div class="container">
                              <div class="row">
                                  <div class="col-md-6">
                  ...
                  <div class="item">
                      <img src="images/adult-booth-business.jpg" alt="slide-4" class="img-responsive">
                      <div class="slider-desc">
                          <div class="container">
                              <div class="row">
                                  <div class="col-md-6">
                          ...
                          <div class="row">
                              <div class="col-md-4">
                                  <div class="cat-sec-1">
                                      ...
                                      <div class="cat-desc">
                                          <div class="cat-inner">
                                              <div class="cat-title">hommes<span>Vêtements</span></div>
                                              <a href="" class="btn btn-border">Acheter</a>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-md-4">
                                  <div class="cat-sec-2">
                                      <img src="images/cat-2.jpg" class="img-responsive" alt="">
                                       <div class="cat-desc">
                                           <div class="cat-inner">
                                              <div class="cat-title">femmes<span>Vêtements</span></div>
                                              <a href="" class="btn btn-border">Acheter</a>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <div class="col-md-4">
                                  <div class="cat-sec-3">
                                      <img src="images/cat-3.jpg" class="img-responsive" alt="">
                                       <div class="cat-desc">
                                           <div class="cat-inner">
                                              <div class="cat-title">accessoires<span>collections - 2019</span></div>
                                              <a href="" class="btn btn-border">Acheter</a>
                                           </div>
                                      </div>
                                  </div>
